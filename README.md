...
## Features
### Username Validation
This checks whether the user has an underscore(_) and is no more than 5 characters long

### Password Validation
This makes sure that the user has at least 8 characters, which consists of a capital letter,a number, and a special character.
